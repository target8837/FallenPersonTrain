...
#pathfall = glob.glob("/home/kwan/PoseTrain/pic/Capture/test/fall/*")
#pathstand = glob.glob("/home/kwan/PoseTrain/pic/Capture/test/stand/*")
pathfall = glob.glob("/home/kwan/PoseTrain/pic/val/fall/*")
pathstand = glob.glob("/home/kwan/PoseTrain/pic/val/stand/*")
...
print(len(trains))
with open('te_json.csv', 'w', newline='') as csvfile:
